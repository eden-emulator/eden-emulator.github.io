        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group relative bg-black/40 backdrop-blur-xs border border-pink-500/30 rounded-xl p-8 hover:border-cyan-400/50 transition-transform duration-300 hover:scale-105"
                style={{
                  background:
              ...
              >
                ...
                <div
                  className={cn(
                    'absolute inset-0 bg-linear-to-r opacity-0 group-hover:opacity-15 rounded-xl blur-sm transition-opacity duration-300',
                    feature.color,
                  )}
                />
