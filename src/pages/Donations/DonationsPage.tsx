    ...
    <>
      ...
      <PageWrapper>
        ...
        <div className="absolute inset-0" aria-hidden="true">
          <div className="absolute top-0 left-1/3 w-72 h-72 bg-pink-500/8 rounded-full blur-xl animate-subtle-pulse" />
          <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-purple-500/8 rounded-full blur-xl animate-float-delay-2" />
          <div className="absolute top-20 right-1/3 w-60 h-60 bg-cyan-500/8 rounded-full blur-xl animate-float-delay-3" />
          <div className="absolute bottom-20 left-1/4 w-72 h-72 bg-blue-500/8 rounded-full blur-xl animate-subtle-pulse-delay-2" />
        </div>
